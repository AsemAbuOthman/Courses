...
void PrintClientData(string accountNumber) 
{
	stClientData ClinetData = GetClientData(accountNumber);

	if (ClinetData.AccountNumber == accountNumber)
	{
		cout << "The following are the client details:\n\n";

		cout << "AccountNumber   : " << ClinetData.AccountNumber << endl;
		cout << "PinCode         : " << ClinetData.PinCode << endl;
		cout << "Name            : " << ClinetData.Name << endl;
		cout << "Phone           : " << ClinetData.Phone << endl;
		cout << "AccountBallance : " << ClinetData.AccountBallance << endl;
	}
	else
	{
