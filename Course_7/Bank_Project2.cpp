...
enum enMainMenuScreen { ShowClient = 1, AddClient = 2, DeleteClient = 3, UpdateClient = 4, FindClient = 5, Tansaction = 6, Exit = 7 };

enum enTransactionMenuOptions { DepositeToClient = 1, WithdrawFromClient = 2, TotalBallacne = 3, MainMenu = 4};
...
void ShowTransactionMenu(short &choice )
{
	...
	system("cls");
	cout << "=====================================" << endl;
	cout << "\t    Transactin Menu Screen" << endl;
	cout << "=====================================" << endl;

	cout << "\t[1] Deposite." << endl;
	cout << "\t[2] Withdraw." << endl;
	cout << "\t[3] Total Ballance." << endl;
...
int CalculateTotalAccountBallance() 
{
	vector<string> vFileContent;
	string fileName = "MyFile.txt";
	string spreator = "#//#";
	...
	for (string &fileContent : vFileContent) 
	{
		...
		vData = ReadDataStoreInVector(fileContent, spreator);
...
void ShowTotalAccountBallance() 
{
	system("cls");
	cout << "=====================================" << endl;
	cout << "\t    Total Ballance" << endl;
	cout << "=====================================" << endl << endl;
	
	PrintClientList();

	cout <<	"Total Ballance is : " << CalculateTotalAccountBallance() << endl;
...
void TransactionMenuScreen()
{
	...
	case enTransactionMenuOptions::DepositeToClient:
	...
	case enTransactionMenuOptions::WithdrawFromClient:
	...
	case enTransactionMenuOptions::TotalBallacne:

		ShowTotalAccountBallance();
...
void MainMenuScreen(short choice)
{
	...
	case enMainMenuScreen::Tansaction:
